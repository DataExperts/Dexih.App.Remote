...
# dotnet restore -r win7-x64 -f netcoreapp2.1
dotnet publish -c release -r win7-x64 -f netcoreapp2.1 --version-suffix C"$version"
dotnet restore -r osx-x64
dotnet publish -c release -r osx-x64 -f netcoreapp2.1 --version-suffix C"$version"
dotnet restore -r linux-x64
dotnet publish -c release -r linux-x64 -f netcoreapp2.1 --version-suffix C"$version"
...
& ".\7za.exe" a ..\dexih.api\wwwroot\remote.binaries\dexih.remote.windows.netcore.zip ./bin/release/netcoreapp2.1/win7-x64/publish/*
& ".\7za.exe" a ..\dexih.api\wwwroot\remote.binaries\dexih.remote.mac.zip ./bin/release/netcoreapp2.1/osx-x64/publish/*
& ".\7za.exe" a ..\dexih.api\wwwroot\remote.binaries\dexih.remote.linux.zip ./bin/release/netcoreapp2.1/linux-x64/publish/*
